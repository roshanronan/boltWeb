...
let stateAccess = React.createRef();
let rateCode = React.createRef();
...
class Register extends Component {
  ...
  apiHandler = async (e) => {
    ...
    let data = {
      ...
      teams: this.state.selectedTeamId,
      userType: userType.current.value,
      stateAccess: stateAccess.current.value,
      rateCode: rateCode.current.value,
    };
    ...
    return (
      <form class="registerForm">
        <div class="registerContainer">
          ...
          <label for="stateAccess" style={{ float: "left" }}>
            Accessible State
          </label>
          <select name="stateAccess" ref={stateAccess} required>
            {/* <option value="">Please Select one or many option</option> */}
            <option value="IN">IN</option>
            <option value="CA">CA</option>
          </select>
          <label for="rateCode" style={{ float: "left" }}>
            Accessible Rate Code
          </label>
          <select name="rateCode" ref={rateCode} required>
            {/* <option value="">Please Select one or many option</option> */}
